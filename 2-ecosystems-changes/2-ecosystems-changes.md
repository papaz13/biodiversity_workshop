...
permalink: /2-ecosystems-changes
has_children: true
nav_order: 2
---
...
- Serie de tutoriales oficiales de Earth Engine sobre el dataset: introducción, búsqueda por similitud, clasificación no supervisada, clasificación supervisada (mapeo de manglares) y regresión (biomasa aérea) — disponibles en [https://developers.google.com/earth-engine/tutorials/community/satellite-embedding-01-introduction?hl=es-419](https://developers.google.com/earth-engine/tutorials/community/satellite-embedding-01-introduction?hl=es-419).
